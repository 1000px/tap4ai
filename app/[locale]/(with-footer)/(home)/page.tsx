...
import MyCarousel from '@/components/explore/MyCarousel';
import TagsChange from './changeTags'
// import Tags from 'path/to/Tags'; // TODO: 使用 Tags 变量进行 XYZ 操作
...
export default async function Page() {
  ...
  const res = await getWebNavigationList({ pageNum: 1, pageSize: 16 });
  const resAll = await getWebNavigationList({ pageNum: 1, pageSize: 0 });
    ...
    <div className='relative w-full'>
      <div className='relative mx-auto w-full max-w-pc flex-1 px-3 lg:px-0'>
        ...
        <div className='flex flex-col gap-5'>
          ...
          <TagsChange dataList={resAll.rows}></TagsChange>
          <WebNavCardList dataList={res.rows} isShowSearch={false} />
          <Link
            href='/explore'
